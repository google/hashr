...
func testImages() ([]*ISO9660, error) {
	isoRepo := NewRepo("testdata")
	gotSources, err := isoRepo.DiscoverRepo()
	if err != nil {
	...
	wantImages := []*ISO9660{
		{
			...
			remotePath: "testdata/20200106.00.00/ubuntu-desktop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.iso",
			remotePath: "testdata/20200106.00.00/ubuntu-laptop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.iso",
			remotePath: "testdata/20200106.00.00/ubuntu-server.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.iso",
			remotePath: "testdata/20200107.00.00/ubuntu-desktop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.iso",
			remotePath: "testdata/20200107.00.00/ubuntu-laptop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.iso",
			remotePath: "testdata/20200107.00.00/ubuntu-server.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.iso",
			remotePath: "testdata/20200107.01.00/ubuntu-desktop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.iso",
			remotePath: "testdata/20200107.01.00/ubuntu-laptop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.iso",
			remotePath: "testdata/20200107.01.00/ubuntu-server.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.iso",
			remotePath: "testdata/20200108.00.00/ubuntu-desktop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.iso",
			remotePath: "testdata/20200108.00.00/ubuntu-laptop.iso",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.iso",
			remotePath: "testdata/20200108.00.00/ubuntu-server.iso",
			repoPath:   "testdata",
		},
	}

	if !cmp.Equal(wantImages, gotImages, cmp.AllowUnexported(ISO9660{})) {
		t.Errorf("Discovery() unexpected diff (-want/+got):\n%s", cmp.Diff(wantImages, gotImages, cmp.AllowUnexported(ISO9660{})))
	}
}
...
func TestQuickHash(t *testing.T) {
	...
	wantHashes := map[string]string{
		"testdata/20200106.00.00/ubuntu-desktop.iso": "627629ead021b428c3d682810867b62f05c44f2c1c64a3c2cc72f74e9e35ca61",
		"testdata/20200106.00.00/ubuntu-server.iso":  "7dc4fb9e8634c6c2456204858ee79c92596afea938095207a35631bcae11bbed",
		"testdata/20200106.00.00/ubuntu-laptop.iso":  "1a1b2eee3631ce3b2346867eb558002055d0a907fa7843dc074cdd4f25db918c",
		"testdata/20200107.01.00/ubuntu-desktop.iso": "465e9d3e6e2f19c02dd04adc6c30992e8145c5228a2249e5c2db65ea45bdeeaf",
		"testdata/20200107.01.00/ubuntu-server.iso":  "a0e827a6e3760a8f15bcb65345800491377a16be8e47f75d67a096eb7c903711",
		"testdata/20200107.01.00/ubuntu-laptop.iso":  "0f9c6f21df00518579997c169aceeecd0074c2a37bdf633f15eebeeea57b5e0b",
		"testdata/20200108.00.00/ubuntu-desktop.iso": "fc26291949dad06b88823c8c23b39315e358b3469b597d46b977fe5851fc150c",
		"testdata/20200108.00.00/ubuntu-server.iso":  "0d88ef74c153813cf0ac606f21ea32d857082861717a6649285076417020f400",
		"testdata/20200108.00.00/ubuntu-laptop.iso":  "246467dbb95170d18b6fb6a671e93f431046c54796f301c3ddf89d344aea6717",
		"testdata/20200107.00.00/ubuntu-desktop.iso": "70ee2234b387ca08580fc55dbe38b9cca321fa68049ee9fa0974a4dd2873527d",
		"testdata/20200107.00.00/ubuntu-server.iso":  "f3d6a7eac5e7d3a4e2478baf72ac23854e4f7814bb1b48e3dd44ff072768eba5",
		"testdata/20200107.00.00/ubuntu-laptop.iso":  "ca364c93337809aa66ed262709ca7023f602a2a793a401c1eafe4dcea573dffc",
	}
...
func TestImageFunctions(t *testing.T) {
	...
	repoPath := "/tmp/iso-repo"
	localisoPath := "/tmp/iso-repo/20200108.00.00-ubuntu-desktop.iso"
	remotePath := "/share/iso-repo/20200108.00.00-ubuntu-desktop.iso"

	img := ISO9660{filename: id, localPath: localisoPath, remotePath: remotePath, repoPath: repoPath}
	...
	if img.LocalPath() != localisoPath {
		t.Errorf("LocalPath() = %s; want = %s", img.LocalPath(), localisoPath)
	}
