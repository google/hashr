...
func testImages() ([]*Archive, error) {
	rpmRepo := NewRepo("testdata")
	gotSources, err := rpmRepo.DiscoverRepo()
	if err != nil {
...
func TestDiscover(t *testing.T) {
	...
	wantImages := []*Archive{
		{
			filename:   "ubuntu-desktop.rpm",
			remotePath: "testdata/20200106.00.00/ubuntu-desktop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.rpm",
			remotePath: "testdata/20200106.00.00/ubuntu-laptop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.rpm",
			remotePath: "testdata/20200106.00.00/ubuntu-server.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.rpm",
			remotePath: "testdata/20200107.00.00/ubuntu-desktop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.rpm",
			remotePath: "testdata/20200107.00.00/ubuntu-laptop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.rpm",
			remotePath: "testdata/20200107.00.00/ubuntu-server.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.rpm",
			remotePath: "testdata/20200107.01.00/ubuntu-desktop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.rpm",
			remotePath: "testdata/20200107.01.00/ubuntu-laptop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.rpm",
			remotePath: "testdata/20200107.01.00/ubuntu-server.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.rpm",
			remotePath: "testdata/20200108.00.00/ubuntu-desktop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.rpm",
			remotePath: "testdata/20200108.00.00/ubuntu-laptop.rpm",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.rpm",
			remotePath: "testdata/20200108.00.00/ubuntu-server.rpm",
			repoPath:   "testdata",
		},
	}
...
func TestQuickHash(t *testing.T) {
	...
	wantHashes := map[string]string{
		"testdata/20200106.00.00/ubuntu-laptop.rpm":  "e9d554110c48dc30eb7d3ecf83b0fd1b28712243109409be3dbd9368f2bf04ef",
		"testdata/20200106.00.00/ubuntu-desktop.rpm": "0604d35c2c910c6cc7118354d26fdbcf8b3bae9e430b0ffe7927ea728dc57b38",
		"testdata/20200106.00.00/ubuntu-server.rpm":  "9fcf51609820d2ad08a0a2ae82c22481928bf33dbf0dc401bdd05222f78672c0",
		"testdata/20200107.00.00/ubuntu-desktop.rpm": "add0914809e7fdf4373aee41c7d635a73c1486f6a7ab7c8e42682fb8e38acc0d",
		"testdata/20200107.00.00/ubuntu-laptop.rpm":  "cfc9ebc6009f7e078378c3d480c5dad62af2fba6ec1970665e0e34e8d329e432",
		"testdata/20200107.00.00/ubuntu-server.rpm":  "4e40a8f11a02f9f45d447f235a733ea20332fb32c04182c5e1f34d60b34a73af",
		"testdata/20200107.01.00/ubuntu-desktop.rpm": "d990e60d885706eb1f387f5d52835efd798d3372d896890fb6956d6e08f9959f",
		"testdata/20200107.01.00/ubuntu-laptop.rpm":  "83f3930902ce1ee4ed8afc0de73e258225068b5bda2744c3c226896f867ee0b6",
		"testdata/20200107.01.00/ubuntu-server.rpm":  "4fa821645900f955e1baf74401665d88f5cef7f69df3a2a3d7968d260833102c",
		"testdata/20200108.00.00/ubuntu-desktop.rpm": "aea004dda71dad202ab5d514205a721db7025c8484e6ae2f8d857e0652e6a0ea",
		"testdata/20200108.00.00/ubuntu-laptop.rpm":  "61b20f9674977cded22281a50cabbf330435fbff3e8c3d50e607bd2f873d9fa7",
		"testdata/20200108.00.00/ubuntu-server.rpm":  "6fcdc016c62dfd7c6d92bfab67a15c8d68dacf9ff7a739a723a5b4f7e884fe73",
	}
...
func TestImageFunctions(t *testing.T) {
	id := "ubuntu-desktop.rpm"
	repoPath := "/tmp/rpm-repo"
	localTarGzPath := "/tmp/rpm-repo/20200108.00.00-ubuntu-desktop.rpm"
	remotePath := "/share/rpm-repo/20200108.00.00-ubuntu-desktop.rpm"
