...
func TestDiscover(t *testing.T) {
	...
	wantImages := []*TarGzFile{
		...
		{
			filename:   "ubuntu-laptop.tar.gz",
			remotePath: "testdata/20200106.00.00/ubuntu-laptop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.tar.gz",
			remotePath: "testdata/20200106.00.00/ubuntu-server.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.tar.gz",
			remotePath: "testdata/20200107.00.00/ubuntu-desktop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.tar.gz",
			remotePath: "testdata/20200107.00.00/ubuntu-laptop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.tar.gz",
			remotePath: "testdata/20200107.00.00/ubuntu-server.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.tar.gz",
			remotePath: "testdata/20200107.01.00/ubuntu-desktop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.tar.gz",
			remotePath: "testdata/20200107.01.00/ubuntu-laptop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.tar.gz",
			remotePath: "testdata/20200107.01.00/ubuntu-server.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.tar.gz",
			remotePath: "testdata/20200108.00.00/ubuntu-desktop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.tar.gz",
			remotePath: "testdata/20200108.00.00/ubuntu-laptop.tar.gz",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.tar.gz",
			remotePath: "testdata/20200108.00.00/ubuntu-server.tar.gz",
			repoPath:   "testdata",
		},
	}
...
func TestQuickHash(t *testing.T) {
	...
	wantHashes := map[string]string{
		"testdata/20200106.00.00/ubuntu-desktop.tar.gz": "02114b6c622e34d7c0d1cd85466ded0f73239ffa9f58d7237660db84f87388f5",
		"testdata/20200106.00.00/ubuntu-laptop.tar.gz":  "59f38b7323b022bc57ff1e364476b70bf657658e18667d8805cdf50f256ae4a9",
		"testdata/20200106.00.00/ubuntu-server.tar.gz":  "a0aabb1e527a8c94f7b81684ba9e1e2816459120e1ad6da99976e31e9e877db3",
		"testdata/20200107.00.00/ubuntu-desktop.tar.gz": "feb7fa320c65a9e29b3483fe26560cddb3fde2ba38bd90bf1e4d4dc4b04f3de0",
		"testdata/20200107.00.00/ubuntu-laptop.tar.gz":  "cf61f593454937129b0b3593e73c19d4fd7a047f06634af451f893587f2723e4",
		"testdata/20200107.00.00/ubuntu-server.tar.gz":  "d23fbdd0f3e4c0a14add9301375d16d9cf965f3e9ef71c7462f439571d66236b",
		"testdata/20200107.01.00/ubuntu-desktop.tar.gz": "e0ddc1042ea35b6bb379c3736250fcb386b1c6050792743fc0f74f8ced2458e2",
		"testdata/20200107.01.00/ubuntu-laptop.tar.gz":  "260adbb876f681fa6b121f78deefb8e5f4d46334acce6ace8aa8def6745a45c7",
		"testdata/20200107.01.00/ubuntu-server.tar.gz":  "9b68ca64c967a2983fab6afc5bab69bf79a021dfc4ea70c5a3901ffca64d1355",
		"testdata/20200108.00.00/ubuntu-desktop.tar.gz": "9be8078448591bb67babe8391770531cba1c6ff01fdb84b4427a6bd78401abb6",
		"testdata/20200108.00.00/ubuntu-laptop.tar.gz":  "2d1e7fb2e02e004d8fbeb3d6e5d9b61c3ae1d047aa514da3c8ceb5ee802baac6",
		"testdata/20200108.00.00/ubuntu-server.tar.gz":  "58e4dedaade2e4ecc118e1fa073308d5960c7e4551db874a8ba3e36e1f636a59",
	}
