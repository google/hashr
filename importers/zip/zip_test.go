...
func testImages() ([]*Archive, error) {
	zipRepo := NewRepo("testdata", "zip,jar,whl,egg")
	gotSources, err := zipRepo.DiscoverRepo()
	if err != nil {
...
func TestDiscover(t *testing.T) {
	...
	wantImages := []*Archive{
		{
			filename:   "ubuntu-desktop.jar",
			remotePath: "testdata/20200106.00.00/ubuntu-desktop.jar",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.whl",
			remotePath: "testdata/20200106.00.00/ubuntu-laptop.whl",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.egg",
			remotePath: "testdata/20200106.00.00/ubuntu-server.egg",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.zip",
			remotePath: "testdata/20200107.00.00/ubuntu-desktop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.zip",
			remotePath: "testdata/20200107.00.00/ubuntu-laptop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.zip",
			remotePath: "testdata/20200107.00.00/ubuntu-server.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.zip",
			remotePath: "testdata/20200107.01.00/ubuntu-desktop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.zip",
			remotePath: "testdata/20200107.01.00/ubuntu-laptop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.zip",
			remotePath: "testdata/20200107.01.00/ubuntu-server.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-desktop.zip",
			remotePath: "testdata/20200108.00.00/ubuntu-desktop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-laptop.zip",
			remotePath: "testdata/20200108.00.00/ubuntu-laptop.zip",
			repoPath:   "testdata",
		},
		{
			filename:   "ubuntu-server.zip",
			remotePath: "testdata/20200108.00.00/ubuntu-server.zip",
			repoPath:   "testdata",
		},
	}
...
func TestQuickHash(t *testing.T) {
	...
	wantHashes := map[string]string{
		"testdata/20200106.00.00/ubuntu-server.egg":  "e7bb7ea11f24e5cbd225666d5c79a0ec1445ddc1c9c03ce79c150172dd1a73cb",
		"testdata/20200106.00.00/ubuntu-desktop.jar": "ebd5bc27e7505a1e29a2d6c888338b166aba39539e1e01ac429078178fbeee9f",
		"testdata/20200106.00.00/ubuntu-laptop.whl":  "a8e4350709700f43ea3cc4c4d662847c493ab2f38f90426c810a6c810224c3c4",
		"testdata/20200107.01.00/ubuntu-server.zip":  "ec71a49487aacf1a5e4e7dac2803fc821f116a2cd147d2978bc2d1eb107314e2",
		"testdata/20200107.01.00/ubuntu-desktop.zip": "2465c22e21e7a23615477a812d874ee7c64174137aefd4d94a17fcb0f4bd8673",
		"testdata/20200107.01.00/ubuntu-laptop.zip":  "04d9a7d32ff5a0eb0941b9dae81f5d0a7c3c311981c61fa63dc5f6216fc91fa4",
		"testdata/20200108.00.00/ubuntu-server.zip":  "94a1e1b85853fc87ff143a98daafa494e8b1da38d24dc4568c651e918c8e042f",
		"testdata/20200108.00.00/ubuntu-desktop.zip": "893f8c19cdec57ffe8fcc52f063460fa62060ad958d33622a46dd9288e9239c7",
		"testdata/20200108.00.00/ubuntu-laptop.zip":  "db02ca436c26f3d8d63b957244e63d530dcc788f2b2ab75cb918777f4c929316",
		"testdata/20200107.00.00/ubuntu-server.zip":  "532730f338fafd72ca0a949e84362aac87062a2aa4effb5008ddc2f0ab77d65f",
		"testdata/20200107.00.00/ubuntu-desktop.zip": "f1910f91037887cf315ec55a720a4b90cc9b586c3dabf27566ec274df50d07cf",
		"testdata/20200107.00.00/ubuntu-laptop.zip":  "4711f2420090435e3697829664a45956912a118ff3f436a4da23553999012079",
	}
...
func TestImageFunctions(t *testing.T) {
	id := "ubuntu-desktop.zip"
	repoPath := "/tmp/zip-repo"
	localzipPath := "/tmp/zip-repo/20200108.00.00-ubuntu-desktop.zip"
	remotePath := "/share/zip-repo/20200108.00.00-ubuntu-desktop.zip"

	img := Archive{filename: id, localPath: localzipPath, remotePath: remotePath, repoPath: repoPath}
	...
	if img.LocalPath() != localzipPath {
		t.Errorf("LocalPath() = %s; want = %s", img.LocalPath(), localzipPath)
	}
...
func TestRepoFunctions(t *testing.T) {
	repoPath := "/tmp/zip-repo"
	repo := NewRepo(repoPath, "zip,jar,whl,egg")
